...
namespace Totov\Cap\Subsets\VehicleKeepers;

use Totov\Cap\Exceptions\AuthorisationFailedException;
use Totov\Cap\Subsets\Subset;
use Totov\Cap\Subsets\VehicleKeepers\Requests\ByVinAndVrmRequest;
use Totov\Cap\Subsets\VehicleKeepers\Requests\ByVinRequest;
use Totov\Cap\Subsets\VehicleKeepers\Requests\ByVrmRequest;

class VehicleKeepers extends Subset
{
    /**
